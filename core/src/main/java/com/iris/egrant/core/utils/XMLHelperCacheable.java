 ...
 *     比对专用 用于时效性不高的场景
 *  add by cg 
 *  @see 参考自 com.iris.egrant.core.utils.XMLHelper 
 * 
 */
@Component
...
/*	
	 ...
	 */
	@Cacheable(value="documentParsed",key="'com.iris.egrant.core.utils.XMLHelperCacheable.parseDocument(String)'+#xmlData" )
	public Document parseDocument(String xmlData) {
		return XMLHelper.parseDocument(xmlData) ; 
	}
	
	@Cacheable(value="w3cDocumentParsed",key="'com.iris.egrant.core.utils.XMLHelperCacheable.parseDoc(Document)'+#doc" )

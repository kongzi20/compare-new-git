...
@Entity
@Table(name = "COMPARE_LIST_SNAPSHOT_JL")
public class CompareListSnapshot implements Serializable {
	...
	public CompareListSnapshot() {
		super();
	}

	public CompareListSnapshot(Long key_code, String content) {
		super();

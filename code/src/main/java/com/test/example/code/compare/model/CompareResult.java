...
public class CompareResult implements Serializable {
	...
	@GenericGenerator(name = "SEQ_COMPARE_RESULT", strategy = "com.test.example.core.dao.hibernate.AssignedSequenceGenerator", parameters = { @Parameter(name = "sequence", value = "SEQ_COMPARE_RESULT") })
	@Column(name = "ID")
	private Long id;

...
public class Proposal implements Serializable {
	...
	@GenericGenerator(name = "SEQ_PRP_CODE", strategy = "com.test.example.core.dao.hibernate.AssignedSequenceGenerator", parameters = { @Parameter(name = "sequence", value = "SEQ_PRP_CODE") })
